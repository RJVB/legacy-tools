/*
 * alsa_hw_capabilities.c - print hardware capabilities
 *
 * compile with: gcc -o alsa_hw_capabilities alsa_hw_capabilities.c -lasound
 */
...
IDENTIFY( "print ALSA's hardware capabilities")
